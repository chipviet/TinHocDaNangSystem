...
export const PromotionDeleteDialog = (props: IPromotionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tinhocdanangApp.promotion.delete.question">
        <Translate contentKey="tinhocdanangApp.promotion.delete.question" interpolate={{ id: promotionEntity.id }}>
