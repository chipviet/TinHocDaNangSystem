  ...
  return (
    <div>
      <h2 id="promotion-heading">
        <Translate contentKey="tinhocdanangApp.promotion.home.title">Promotions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="tinhocdanangApp.promotion.home.createLabel">Create new Promotion</Translate>
        </Link>
      </h2>
        ...
        {promotionList && promotionList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('desciption')}>
                  <Translate contentKey="tinhocdanangApp.promotion.desciption">Desciption</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('linkToPromotionalProducts')}>
            ...
            <tbody>
              {promotionList.map((promotion, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{promotion.desciption}</td>
                  <td>{promotion.linkToPromotionalProducts}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tinhocdanangApp.promotion.home.notFound">No Promotions found</Translate>
            </div>
          )
        )}
      </div>
