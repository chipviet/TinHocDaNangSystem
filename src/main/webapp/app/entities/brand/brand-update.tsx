  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tinhocdanangApp.brand.home.createOrEditLabel">
            <Translate contentKey="tinhocdanangApp.brand.home.createOrEditLabel">Create or edit a Brand</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : brandEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="iconURLLabel" for="brand-iconURL">
                  <Translate contentKey="tinhocdanangApp.brand.iconURL">Icon URL</Translate>
                </Label>
                <AvField id="brand-iconURL" type="text" name="iconURL" />
              </AvGroup>
